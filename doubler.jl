...
function doubler(cc1,cc2,magrsite1,magrsite2,magr1in,magr2in,
...
@sprintf(1,'start of loop  %11.7f  %11.7f  \n',magr1in,magr2in );
   magr1 = norm(r1);
   magr2 = norm(r2);
   @sprintf("r1  %11.7f   %11.7f  %11.7f ",r1);
   @sprintf("r2  %11.7f   %11.7f  %11.7f \n",r2);
#    @sprintf(1,'r1  #11.7f   #11.7f  #11.7f \n',r1/re);
#    @sprintf(1,'r2  #11.7f   #11.7f  #11.7f   #11.7f  #11.7f  #11.7f \n',r2/re, r2);
...
#pause;
    r3 = rho3.*los3 + rsite3;
    println(@sprintf("r3  %11.7f   %11.7f  %11.7f ",r3[1],r3[2],r3[3]));
#    @sprintf(1,'r3  #11.7f   #11.7f  #11.7f \n',r3/re);
    magr3 = norm(r3);
@sprintf("after 1st mag  %11.7f  %11.7f  %11.7f \n",magr1,magr2,magr3 );
...
dv32 = atan2(sindv32,cosdv32);
    ...
    if e*e < 0.99
        ...
        @sprintf(1,'hyperbolic, e1 is greater than 0.99 %11.7f \n',e);
        n = sqrt(mu/-a^3);
...
@sprintf("dm32 %11.7f  dm12 %11.7f %11.7f %11.7f %11.7f %11.7f %11.7f %11.7f %11.7f \n",deltam32,deltam12,c1,c3,p,a,e,s,c );
@sprintf("%11.7f %11.7f %11.7f \n"dv21,dv31,dv32 );
    f1 = t1-deltam12/n;
    f2 = t3-deltam32/n;
