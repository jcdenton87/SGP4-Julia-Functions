"""
# This is a vectorized version of the MATLAB sgp4init.m function provided with
# AIAA 2006-6753, "Revisiting Spacetrack Report #3," available at
# http://celestrak.com/publications/AIAA/2006-6753/.  Instead of pointing
# to the original dpper.m, dspace.m, and spg4.m functions, it calls the
# vectorized versions instead.  This allows these three functions to be
# removed from the working directory entirely.
...
function sgp4init_vectorized(whichconst, satrec, xbstar, xecco, epoch,
   ...
   ainv,  ao,     satrec.con41,   con42,  cosio,  cosio2, einv,   eccsq,
           ...
           satrec.gsto,    satrec.no  = initl(satrec.ecco,    epoch,  satrec.inclo,   satrec.no,
           satrec.satnum);
   ...
   if ((omeosq >= 0.0 ) || ( satrec.no >= 0.0))
       ...
       if ((2*pi / satrec.no) >= 225.0)
           ...
           sinim,cosim,sinomm,cosomm,snodm,cnodm,day,satrec.e3,satrec.ee2,
               ...
               z21,z22,z23,z31,z32,z33,satrec.zmol,satrec.zmos = dscom(epoch,satrec.ecco,satrec.argpo,tc,satrec.inclo,
               satrec.nodeo,satrec.no);

           satrec.ecco,satrec.inclo,satrec.nodeo,satrec.argpo,satrec.mo = dpper_vectorized(satrec.e3,satrec.ee2,satrec.peo,satrec.pgho, #sending vectorized
               satrec.pho,satrec.pinco,satrec.plo,satrec.se2,satrec.se3,       #version a scalar t=0
           ...
           em,argpm,inclm,mm,nm,nodem,satrec.irez,satrec.atime,
               ...
               satrec.xfact,satrec.xlamo,satrec.xli,satrec.xni = dsinit(cosim,emsq,satrec.argpo,s1,s2,s3,s4,s5,sinim,ss1,ss2,ss3,
   ...
   if(satrec.error == 0)
       satrec, r, v = sgp4_vectorized(satrec, 0.0); #sending vectorized version a scalar t=0
   end
